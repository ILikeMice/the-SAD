...
websocket.addEventListener("message", (event) => {
    ...
    if (message.type === "crank") {
        ...
        console.log(crank); // @ts-ignore
        browser.runtime.sendMessage(
            { type: "crank", value: crank }, // @ts-ignore
            function (response) {
        ...
        console.log(humidity); // @ts-ignore
        chrome.runtime.sendMessage( 
            { type: "crank", value: humidity }, // @ts-ignore
            function (response) {
                console.log(response.farewell);
            }
        );
